...
All notable changes to pdftool.work are documented in this file.

The project uses `MAJOR.MINOR.PATCH.MICRO` version numbers.
...
- Document local development, testing, deployment, and post-approval AdSense configuration.

### Fixed

- Keep damaged-PDF error messages visible after page-management and compression state resets.
